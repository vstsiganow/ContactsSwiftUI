...
final class DataManager {
    ...
    var emailList = ["miltchev@gmail.com", "curly@yahoo.ca", "szymansk@att.net", "cgarcia@yahoo.com", "bartlett@verizon.net", "johnbob@aol.com", "epeeist@optonline.net", "ianbuck@icloud.com", "rcwil@comcast.net", "jbarta@mac.com", "hhdgdt@mac.com"]
    ...
    func randomDummyPerson() -> Person {
        ...
        let person = Person(firstName: fName, lastName: lName, email: email, phoneNumber: phone)
        print(person)
